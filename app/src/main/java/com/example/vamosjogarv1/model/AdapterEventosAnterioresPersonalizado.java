...
import com.example.vamosjogarv1.controller.tela_lista_eventos_anteriores;

import java.util.List;

public class AdapterEventosAnterioresPersonalizado extends BaseAdapter {
    private final List<Evento> eventos;
    private final Activity act;

    public AdapterEventosAnterioresPersonalizado(List<Evento> evento, List<Evento> eventos, tela_lista_eventos_anteriores act) {
